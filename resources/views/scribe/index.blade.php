...
<head>
    ...
    <title>Nexora Collectives Documentation</title>
    ...
    <script>
        var tryItOutBaseUrl = "https://nexora-api.test/";
        var useCsrf = Boolean();
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth-management">
                    <a href="#auth-management">Auth Management</a>
                                    ...
                                    <ul id="tocify-subheader-auth-management" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="auth-management-GETapi-v1-permissions">
                                <a href="#auth-management-GETapi-v1-permissions">List all available permissions.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-management-GETapi-v1-roles">
                                <a href="#auth-management-GETapi-v1-roles">List all available roles along with their permissions.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-management-POSTapi-v1-roles">
                                <a href="#auth-management-POSTapi-v1-roles">Create a new role.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-management-PUTapi-v1-roles--id-">
                                <a href="#auth-management-PUTapi-v1-roles--id-">Update an existing role.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-management-DELETEapi-v1-roles--id-">
                                <a href="#auth-management-DELETEapi-v1-roles--id-">Delete a role.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-v1-forgot-password">Send password reset link.</a>
                            </li>
                    ...
                    <ul id="tocify-header-common" class="tocify-header">
                <li class="tocify-item level-1" data-unique="common">
                    <a href="#common">Common</a>
                </li>
                                    <ul id="tocify-subheader-common" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="common-POSTapi-v1-toggle-active">
                                <a href="#common-POSTapi-v1-toggle-active">Toggle the active status of a model.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="common-GETapi-v1-statuses--model-">
                                <a href="#common-GETapi-v1-statuses--model-">Get statuses for a given model.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="contacts">
                    <a href="#contacts">Contacts</a>
                                ...
                                <a href="#contacts-GETapi-v1-contacts">Display contact listing.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="contacts-POSTapi-v1-contacts">
                                <a href="#contacts-POSTapi-v1-contacts">Store a new Contact</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="contacts-GETapi-v1-contacts--id-">
                                <a href="#contacts-GETapi-v1-contacts--id-">Display a Contact</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="contacts-PUTapi-v1-contacts--id-">
                                <a href="#contacts-PUTapi-v1-contacts--id-">Update Contact</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="contacts-DELETEapi-v1-contacts--id-">
                                <a href="#contacts-DELETEapi-v1-contacts--id-">Remove Contact</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="email-verification">
                    <a href="#email-verification">Email Verification</a>
                                    ...
                                    <ul id="tocify-subheader-email-verification" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="email-verification-GETapi-v1-verify-email--id---hash-">
                                <a href="#email-verification-GETapi-v1-verify-email--id---hash-">Verify user email.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="email-verification-POSTapi-v1-email-verification-notification">
                                <a href="#email-verification-POSTapi-v1-email-verification-notification">Resend email verification link.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-up">
                                <a href="#endpoints-GETapi-v1-up">Health check.</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-followup" class="tocify-header">
                <li class="tocify-item level-1" data-unique="followup">
                    <a href="#followup">FollowUp</a>
                </li>
                                    <ul id="tocify-subheader-followup" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="followup-GETapi-v1-follow-ups">
                                <a href="#followup-GETapi-v1-follow-ups">Display follow-up listing.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="followup-POSTapi-v1-follow-ups">
                                <a href="#followup-POSTapi-v1-follow-ups">Store a new FollowUp</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="followup-GETapi-v1-follow-ups--id-">
                                <a href="#followup-GETapi-v1-follow-ups--id-">Display a FollowUp</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="followup-PUTapi-v1-follow-ups--id-">
                                <a href="#followup-PUTapi-v1-follow-ups--id-">Update FollowUp</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="followup-DELETEapi-v1-follow-ups--id-">
                                <a href="#followup-DELETEapi-v1-follow-ups--id-">Remove FollowUp</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="leads">
                    <a href="#leads">Leads</a>
                                ...
                                <a href="#leads-GETapi-v1-leads">Display lead listing.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="leads-POSTapi-v1-leads">
                                <a href="#leads-POSTapi-v1-leads">Store a new Lead</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="leads-GETapi-v1-leads--id-">
                                <a href="#leads-GETapi-v1-leads--id-">Display a Lead</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="leads-PUTapi-v1-leads--id-">
                                <a href="#leads-PUTapi-v1-leads--id-">Update Lead</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="leads-DELETEapi-v1-leads--id-">
                                <a href="#leads-DELETEapi-v1-leads--id-">Remove Lead</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="media-management">
                    <a href="#media-management">Media Management</a>
                                    ...
                                    <ul id="tocify-subheader-media-management" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="media-management-GETapi-v1-media">
                                <a href="#media-management-GETapi-v1-media">List all media files.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="media-management-POSTapi-v1-media">
                                <a href="#media-management-POSTapi-v1-media">Upload a new media file.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="media-management-DELETEapi-v1-media--media_id-">
                                <a href="#media-management-DELETEapi-v1-media--media_id-">Delete a media file.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user-profile">
                    <a href="#user-profile">User Profile</a>
                                ...
                                <a href="#user-profile-GETapi-v1-me">Get authenticated user profile.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-profile-POSTapi-v1-me">
                                <a href="#user-profile-POSTapi-v1-me">Update authenticated user profile.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-profile-POSTapi-v1-change-password">
                                <a href="#user-profile-POSTapi-v1-change-password">Change authenticated user password.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>A comprehensive API for Nexora Collectives, featuring authentication, user management, and module-specific endpoints.</p>
<aside>
    <strong>Base URL</strong>: <code>https://nexora-api.test/</code>
</aside>
<pre><code>    This documentation provides detailed information on how to interact with the Nexora Collectives API.
    It covers authentication, user profiles, and other core features.</code></pre>

        <h1 id="authenticating-requests">Authenticating requests</h1>
<p>To authenticate requests, include an <strong><code>Authorization</code></strong> header with the value <strong><code>"Bearer {YOUR_AUTH_KEY}"</code></strong>.</p>
<p>All authenticated endpoints are marked with a <code>requires authentication</code> badge in the documentation below.</p>
<p>Use the login endpoint to retrieve your Bearer token.</p>

        <h1 id="auth-management">Auth Management</h1>

    

                                <h2 id="auth-management-GETapi-v1-permissions">List all available permissions.</h2>
...
<div class="bash-example">
    ...
    --get "https://nexora-api.test/api/v1/permissions" \
...
<div class="javascript-example">
    ...
    "https://nexora-api.test/api/v1/permissions"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-management-GETapi-v1-roles">List all available roles along with their permissions.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/roles" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/roles"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-management-POSTapi-v1-roles">Create a new role.</h2>
...
<small>string[]</small>&nbsp;
 ...
 &nbsp;
    ...
    <br>
                    ...
                    <h2 id="auth-management-PUTapi-v1-roles--id-">Update an existing role.</h2>
...
<div class="bash-example">
    ...
    "https://nexora-api.test/api/v1/roles/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"b\",
...
<p>The <code>name</code> of an existing record in the permissions table.</p>
                    ...
                    <h2 id="auth-management-DELETEapi-v1-roles--id-">Delete a role.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://nexora-api.test/api/v1/register" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"b\",
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://nexora-api.test/api/v1/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<p>Example: <code>|]|{+-</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-forgot-password">Send password reset link.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://nexora-api.test/api/v1/forgot-password" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"email\": \"gbailey@example.net\"
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://nexora-api.test/api/v1/reset-password" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"token\": \"architecto\",
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://nexora-api.test/api/v1/logout" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="common">Common</h1>
                                ...
                                <h2 id="common-POSTapi-v1-toggle-active">Toggle the active status of a model.</h2>
...
<span id="example-requests-POSTapi-v1-toggle-active">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://nexora-api.test/api/v1/toggle-active" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"model\": null,
...
<span id="example-responses-POSTapi-v1-toggle-active">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-POSTapi-v1-toggle-active" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-toggle-active"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-toggle-active"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-toggle-active" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-toggle-active">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-toggle-active" data-method="POST"
      data-path="api/v1/toggle-active"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-toggle-active', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-toggle-active"
                    onclick="tryItOut('POSTapi-v1-toggle-active');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-toggle-active"
                    onclick="cancelTryOut('POSTapi-v1-toggle-active');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-toggle-active"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/toggle-active</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-toggle-active"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-toggle-active"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="model"                data-endpoint="POSTapi-v1-toggle-active"
               value=""
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-toggle-active"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="common-GETapi-v1-statuses--model-">Get statuses for a given model.</h2>
...
<span id="example-requests-GETapi-v1-statuses--model-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/statuses/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/statuses/architecto"
);
...
<span id="example-responses-GETapi-v1-statuses--model-">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-statuses--model-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-statuses--model-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-statuses--model-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-statuses--model-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-statuses--model-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-statuses--model-" data-method="GET"
      data-path="api/v1/statuses/{model}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-statuses--model-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-statuses--model-"
                    onclick="tryItOut('GETapi-v1-statuses--model-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-statuses--model-"
                    onclick="cancelTryOut('GETapi-v1-statuses--model-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-statuses--model-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/statuses/{model}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-statuses--model-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-statuses--model-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="model"                data-endpoint="GETapi-v1-statuses--model-"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
                ...
                <h1 id="contacts">Contacts</h1>
                                ...
                                <h2 id="contacts-GETapi-v1-contacts">Display contact listing.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/contacts" \
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/contacts"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="contacts-POSTapi-v1-contacts">Store a new Contact</h2>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="contacts-GETapi-v1-contacts--id-">Display a Contact</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/contacts/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/contacts/architecto"
);
...
<p>The ID of the contact. Example: <code>architecto</code></p>
                    ...
                    <h2 id="contacts-PUTapi-v1-contacts--id-">Update Contact</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company"                data-endpoint="PUTapi-v1-contacts--id-"
               value="d"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>d</code></p>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="contacts-DELETEapi-v1-contacts--id-">Remove Contact</h2>
...
<p>The ID of the contact. Example: <code>architecto</code></p>
                ...
                <h1 id="email-verification">Email Verification</h1>
                                ...
                                <h2 id="email-verification-GETapi-v1-verify-email--id---hash-">Verify user email.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/verify-email/architecto/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/verify-email/architecto/architecto"
);
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="email-verification-POSTapi-v1-email-verification-notification">Resend email verification link.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://nexora-api.test/api/v1/email/verification-notification" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-v1-up">Health check.</h2>
...
<span id="example-requests-GETapi-v1-up">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/up" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/up"
);
...
<span id="example-responses-GETapi-v1-up">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-up" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-up"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-up"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-up" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-up">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-up" data-method="GET"
      data-path="api/v1/up"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-up', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-up"
                    onclick="tryItOut('GETapi-v1-up');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-up"
                    onclick="cancelTryOut('GETapi-v1-up');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-up"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-up"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-up"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="followup">FollowUp</h1>
                                ...
                                <h2 id="followup-GETapi-v1-follow-ups">Display follow-up listing.</h2>
...
<span id="example-requests-GETapi-v1-follow-ups">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/follow-ups" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/follow-ups"
);
...
<span id="example-responses-GETapi-v1-follow-ups">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-follow-ups" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-follow-ups"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-follow-ups"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-follow-ups" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-follow-ups">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-follow-ups" data-method="GET"
      data-path="api/v1/follow-ups"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-follow-ups', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-follow-ups"
                    onclick="tryItOut('GETapi-v1-follow-ups');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-follow-ups"
                    onclick="cancelTryOut('GETapi-v1-follow-ups');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-follow-ups"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/follow-ups</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-follow-ups"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-follow-ups"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-follow-ups"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="followup-POSTapi-v1-follow-ups">Store a new FollowUp</h2>
...
<span id="example-requests-POSTapi-v1-follow-ups">
<blockquote>Example request:</blockquote>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"lead_id\": \"6ff8f7f6-1eb3-3525-be4a-3932c805afed\",
    \"type\": \"message\",
    \"status\": \"architecto\",
    \"follow_up_at\": \"2026-01-03 22:14:16\",
    \"notes\": \"architecto\"
}"
</code></pre></div>
...
<span id="example-responses-POSTapi-v1-follow-ups">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-POSTapi-v1-follow-ups" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-follow-ups"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-follow-ups"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-follow-ups" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-follow-ups">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-follow-ups" data-method="POST"
      data-path="api/v1/follow-ups"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-follow-ups', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-follow-ups"
                    onclick="tryItOut('POSTapi-v1-follow-ups');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-follow-ups"
                    onclick="cancelTryOut('POSTapi-v1-follow-ups');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-follow-ups"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-follow-ups"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-follow-ups"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-follow-ups"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="lead_id"                data-endpoint="POSTapi-v1-follow-ups"
               value="6ff8f7f6-1eb3-3525-be4a-3932c805afed"
               data-component="body">
    <br>
<p>Must be a valid UUID. The <code>id</code> of an existing record in the leads table. Example: <code>6ff8f7f6-1eb3-3525-be4a-3932c805afed</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="POSTapi-v1-follow-ups"
               value="message"
               data-component="body">
    <br>
<p>Example: <code>message</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>call</code></li> <li><code>email</code></li> <li><code>message</code></li> <li><code>meeting</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="POSTapi-v1-follow-ups"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>completed</code></li> <li><code>cancelled</code></li></ul>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>follow_up_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="follow_up_at"                data-endpoint="POSTapi-v1-follow-ups"
               value="2026-01-03 22:14:16"
               data-component="body">
    <br>
<p>Must be a valid date in the format <code>Y-m-d H:i:s</code>. Example: <code>2026-01-03 22:14:16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>notes</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="POSTapi-v1-follow-ups"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="followup-GETapi-v1-follow-ups--id-">Display a FollowUp</h2>
...
<span id="example-requests-GETapi-v1-follow-ups--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/follow-ups/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/follow-ups/architecto"
);
...
<span id="example-responses-GETapi-v1-follow-ups--id-">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-follow-ups--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-follow-ups--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-follow-ups--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-follow-ups--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-follow-ups--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-follow-ups--id-" data-method="GET"
      data-path="api/v1/follow-ups/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-follow-ups--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-follow-ups--id-"
                    onclick="tryItOut('GETapi-v1-follow-ups--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-follow-ups--id-"
                    onclick="cancelTryOut('GETapi-v1-follow-ups--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-follow-ups--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/follow-ups/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-follow-ups--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-follow-ups--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-follow-ups--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-follow-ups--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the follow up. Example: <code>architecto</code></p>
            </div>
                    </form>

                    <h2 id="followup-PUTapi-v1-follow-ups--id-">Update FollowUp</h2>
...
<span id="example-requests-PUTapi-v1-follow-ups--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-follow-ups--id-">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-PUTapi-v1-follow-ups--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-follow-ups--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-follow-ups--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-follow-ups--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-follow-ups--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-follow-ups--id-" data-method="PUT"
      data-path="api/v1/follow-ups/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-follow-ups--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-follow-ups--id-"
                    onclick="tryItOut('PUTapi-v1-follow-ups--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-follow-ups--id-"
                    onclick="cancelTryOut('PUTapi-v1-follow-ups--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-follow-ups--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-v1-follow-ups--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-follow-ups--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-follow-ups--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-v1-follow-ups--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the follow up. Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="PUTapi-v1-follow-ups--id-"
               value="meeting"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PUTapi-v1-follow-ups--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="follow_up_at"                data-endpoint="PUTapi-v1-follow-ups--id-"
               value="2026-01-03 22:14:16"
               data-component="body">
    <br>
<p>Must be a valid date in the format <code>Y-m-d H:i:s</code>. Example: <code>2026-01-03 22:14:16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="PUTapi-v1-follow-ups--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="followup-DELETEapi-v1-follow-ups--id-">Remove FollowUp</h2>
...
<span id="example-requests-DELETEapi-v1-follow-ups--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-follow-ups--id-">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-DELETEapi-v1-follow-ups--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-follow-ups--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-follow-ups--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-follow-ups--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-follow-ups--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-follow-ups--id-" data-method="DELETE"
      data-path="api/v1/follow-ups/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-follow-ups--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-follow-ups--id-"
                    onclick="tryItOut('DELETEapi-v1-follow-ups--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-follow-ups--id-"
                    onclick="cancelTryOut('DELETEapi-v1-follow-ups--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-follow-ups--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-follow-ups--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-follow-ups--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-follow-ups--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-follow-ups--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the follow up. Example: <code>architecto</code></p>
                ...
                <h1 id="leads">Leads</h1>
                                ...
                                <h2 id="leads-GETapi-v1-leads">Display lead listing.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/leads" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/leads"
);
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-leads"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="leads-POSTapi-v1-leads">Store a new Lead</h2>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"contact_id\": \"6ff8f7f6-1eb3-3525-be4a-3932c805afed\",
    \"first_name\": \"g\",
    \"last_name\": \"z\",
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="contact_id"                data-endpoint="POSTapi-v1-leads"
               value="6ff8f7f6-1eb3-3525-be4a-3932c805afed"
               data-component="body">
    <br>
<p>Must be a valid UUID. The <code>id</code> of an existing record in the contacts table. Example: <code>6ff8f7f6-1eb3-3525-be4a-3932c805afed</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>first_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="POSTapi-v1-leads"
               value="g"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="POSTapi-v1-leads"
               value="z"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company"                data-endpoint="POSTapi-v1-leads"
               value="j"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="POSTapi-v1-leads"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>new</code></li> <li><code>contacted</code></li> <li><code>qualified</code></li> <li><code>proposal_sent</code></li> <li><code>negotiating</code></li> <li><code>won</code></li> <li><code>lost</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="comment"                data-endpoint="POSTapi-v1-leads"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="leads-GETapi-v1-leads--id-">Display a Lead</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/leads/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/leads/architecto"
);
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-leads--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-leads--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the lead. Example: <code>architecto</code></p>
                    ...
                    <h2 id="leads-PUTapi-v1-leads--id-">Update Lead</h2>
...
<span id="example-requests-PUTapi-v1-leads--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-leads--id-">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-PUTapi-v1-leads--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-leads--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-leads--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-leads--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-leads--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-leads--id-" data-method="PUT"
      data-path="api/v1/leads/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-leads--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-leads--id-"
                    onclick="tryItOut('PUTapi-v1-leads--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-leads--id-"
                    onclick="cancelTryOut('PUTapi-v1-leads--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-leads--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-v1-leads--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-leads--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-leads--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-v1-leads--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the lead. Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="contact_id"                data-endpoint="PUTapi-v1-leads--id-"
               value="6ff8f7f6-1eb3-3525-be4a-3932c805afed"
               data-component="body">
    <br>
<p>Must be a valid UUID. The <code>id</code> of an existing record in the contacts table. Example: <code>6ff8f7f6-1eb3-3525-be4a-3932c805afed</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="PUTapi-v1-leads--id-"
               value="g"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>g</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="PUTapi-v1-leads--id-"
               value="z"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>z</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PUTapi-v1-leads--id-"
               value="rempel.chadrick@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>rempel.chadrick@example.org</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="PUTapi-v1-leads--id-"
               value="l"
               data-component="body">
    <br>
<p>Must not be greater than 50 characters. Example: <code>l</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company"                data-endpoint="PUTapi-v1-leads--id-"
               value="j"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>j</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PUTapi-v1-leads--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="comment"                data-endpoint="PUTapi-v1-leads--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="leads-DELETEapi-v1-leads--id-">Remove Lead</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-leads--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-leads--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the lead. Example: <code>architecto</code></p>
                ...
                <h1 id="media-management">Media Management</h1>
                                ...
                                <h2 id="media-management-GETapi-v1-media">List all media files.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/media?per_page=15&amp;search=image&amp;type=image%2Fjpeg" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/media"
);
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Items per page. Defaults to 15. Example: <code>15</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="search"                data-endpoint="GETapi-v1-media"
               value="image"
               data-component="query">
    <br>
<p>Filter by name or original name. Example: <code>image</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>type</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="GETapi-v1-media"
               value="image/jpeg"
               data-component="query">
    <br>
<p>Filter by mime type. Example: <code>image/jpeg</code></p>
            </div>
                </form>

                    <h2 id="media-management-POSTapi-v1-media">Upload a new media file.</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The file to upload. Max 10MB. Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="media-management-DELETEapi-v1-media--media_id-">Delete a media file.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "https://nexora-api.test/api/v1/media/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="media_id"                data-endpoint="DELETEapi-v1-media--media_id-"
               value="architecto"
               data-component="url">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="media"                data-endpoint="DELETEapi-v1-media--media_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the media. Example: <code>1</code></p>
                ...
                <h1 id="user-profile">User Profile</h1>
                                ...
                                <h2 id="user-profile-GETapi-v1-me">Get authenticated user profile.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://nexora-api.test/api/v1/me" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://nexora-api.test/api/v1/me"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-profile-POSTapi-v1-me">Update authenticated user profile.</h2>
...
<span id="example-requests-POSTapi-v1-me">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-me">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-POSTapi-v1-me" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-me"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-me"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-me" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-me">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-me" data-method="POST"
      data-path="api/v1/me"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-me', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-me"
                    onclick="tryItOut('POSTapi-v1-me');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-me"
                    onclick="cancelTryOut('POSTapi-v1-me');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-me"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-me"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-me"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-v1-me"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-v1-me"
               value="zbailey@example.net"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>zbailey@example.net</code></p>
                    ...
                    <h2 id="user-profile-POSTapi-v1-change-password">Change authenticated user password.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://nexora-api.test/api/v1/change-password" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
